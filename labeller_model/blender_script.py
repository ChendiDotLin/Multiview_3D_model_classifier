...
parser.add_argument("--output_dir", type=str, default="/data/home/ancao/source/objaverse_rendering/results/hf-objaverse-v1/views_whole_sphere")
parser.add_argument(
...
def save_images(object_file: str) -> None:
    ...
    for i in range(args.num_images):
        ...
        # render the image
        depth_file_output_node.file_slots[0].path = os.path.join(args.output_dir, object_uid, f"{i:03d}_depth.#")
